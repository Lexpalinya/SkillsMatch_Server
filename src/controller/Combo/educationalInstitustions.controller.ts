...
export class EducationalInstitustionsController {
  private controller;
  private educationalInstitustionsService;
  constructor() {
    this.educationalInstitustionsService = new EducationalInstitutionsService();
    this.controller = new ModeldelHandlerController(
      this.educationalInstitustionsService,
